    ...
    static listUsers(req, res) {
        ...
        if (filter !== undefined) {
            ...
            db.getFilteredUsers(attributeName, attributeValue, startIndex, count, reqUrl, function (result) {
                ...
                // out.log('listUsers - start')
                // out.log(JSON.stringify(result, null, 2));
                // out.log('listUsers - end')

                result.startIndex = parseInt(result.startIndex)
                result.totalResults = parseInt(result.totalResults)
                result.itemsPerPage = parseInt(result.itemsPerPage)
